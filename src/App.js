...
function App() {
  ...
  // функция удаления списка строк
//   const deleteRow = () => {
//   if (id) {
//     axios
//     .delete(`http://185.244.172.108:8081/v1/outlay-rows/entity/${id}/row/${id}/delete`)
//     .then(res => {
      ...
      .then((response) => {
        ...
        const rowUpdater = (rows, path) => {
          ...
          if (path.length > 0) {
            ...
            // если путь закончился, то у тебя в ссылка на нужный тебе массив, в который можно складывать строку
  ...
  return (
    <div className="app">
      ...
      <Table 
        ...
        />
      {/* <Table list={rows} setRow={setRow} deleteHandler={deleteHandler}/> */}
    </div>
  );
}
